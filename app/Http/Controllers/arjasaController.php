...
class arjasaController extends Controller
{
    // {{{ construct
    ...
    public function index()
    {
        ...
        /* return view('peta.arjasa', compact('pipa1','pipa1Setengah', 'pipa2', 'pipa3','pipa4', 'pipa6', 'pipa8','pipa12', 'pelanggan')); */
        return view('peta.arjasa', compact('pipa1', 'pipa1Setengah', 'pipa2', 'pipa3', 'pipa4', 'pipa6', 'pipa8', 'pipa12', 'sumurboor'));
    } // }}}
