...
var overLayers = [{
    ...
    layers: [{
        name: 'Gate Valve',
        layer: new L.GeoJSON.AJAX(["public/maps/gateValve/01/01-gateValve.geojson"], {
        ...
        {
            name: 'Pipa Pelayanan',
            layer: new L.GeoJSON.AJAX(["public/maps/pipapelayanan/01/01-pipapelayanan.geojson"], {
        ...
        },
        {
            ...
            layer: new L.GeoJSON.AJAX(["public/maps/pipadist/01/01-pipadist-110mm-4i.geojson"], {
        ...
        },
        {
            ...
            layer: new L.GeoJSON.AJAX(["public/maps/pipadist/01/01-pipadist-160mm-6i.geojson"], {
        ...
        {
            name: 'Sumur Boor',
            layer: new L.GeoJSON.AJAX(["public/maps/sumurboor/01/01-sumurboor.geojson"], {
        ...
        },
        {
            ...
            layer: new L.GeoJSON.AJAX(["public/maps/pelanggan/01/01-pelanggan-I.geojson"], {
        ...
        },
        {
            ...
            layer: new L.GeoJSON.AJAX(["public/maps/pelanggan/01/01-pelanggan-II.geojson"], {
                pointToLayer: clusterPelanggan,
                onEachFeature: function (feature, layer) {
                    // layer.bindPopup('Nama Pelanggan : ' + feature.properties.NAMAPELANG);
                    layer.bindPopup(popUpPelanggan(feature, layer));
        ...
        },
        {
            ...
            layer: new L.GeoJSON.AJAX(["public/maps/pelanggan/01/01-pelanggan-III.geojson"], {
                pointToLayer: clusterPelanggan,
                onEachFeature: function (feature, layer) {
                    // layer.bindPopup('Nama Pelanggan : ' + feature.properties.NAMAPELANG);
                    layer.bindPopup(popUpPelanggan(feature, layer));
        ...
        },
        {
            ...
            layer: new L.GeoJSON.AJAX(["public/maps/pelanggan/01/01-pelanggan-IV.geojson"], {
                pointToLayer: clusterPelanggan,
                onEachFeature: function (feature, layer) {
                    layer.bindPopup(popUpPelanggan(feature, layer));
                }
        ...
        },
        {
            ...
            layer: new L.GeoJSON.AJAX(["public/maps/pelanggan/01/01-pelanggan-V.geojson"], {
                pointToLayer: clusterPelanggan,
                onEachFeature: function (feature, layer) {
                    layer.bindPopup(popUpPelanggan(feature, layer));
                }
...
var searchControl = new L.Control.Search({
    // layer: overLayers[0].layers[5].layer,
    layer: '',
    propertyName: '',
    marker: false,
...
//     // featuresLayer.eahLayer(function (layer) { // restore feature layer
//     //     featuresLayer.resetStyle(layer);
//     // });
// });
m.addControl(searchControl); // inizialize search control
// console.log(overLayers[0].layers[5].layer);
